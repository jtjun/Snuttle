...
public class PredictionTSGreedy{
    public static ArrayList<Integer> cycle;

    public static void setPTSGreedySchedule(Shuttle[] shuttles, Map map, ArrayList<Guest> guests, int fixedshuttle){
    ...
    public static void setPTSGreedyEach(Shuttle[] shuttles, int shuttlenum, int time, Request R){
